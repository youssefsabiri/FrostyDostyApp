...
public class LoginHomeGUI extends JFrame {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	public JFrame frame;
    public LoginHomeGUI(Client cl) {
        setTitle("Login");
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        getContentPane().setLayout(new BorderLayout());
        setBackground(Color.BLACK);

        ImageIcon imageIcon = new ImageIcon(LoginHomeGUI.class.getResource("frosty.png"));
        ...
        loginButton.addActionListener(e -> {
			...
			Login login = new Login(this); // Pass the parent JFrame here
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> new LoginHomeGUI(cl));
    }
}
