...
import Exceptions.AddOrderVerification;
...
public class AddOrderGUI extends JFrame {
    ...
    public AddOrderGUI(CardLayout contentCardLayout, JPanel contentPanel) {
        // Set up the frame
        ...
        enterButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	...
            	vr.verify(productname, quantity, contentCardLayout, contentPanel);
    ...
    public static void main(String[] args) {
        ...
        AddOrderGUI form = new AddOrderGUI(contentCardLayout, contentPanel);
    }
}