...
public class SearchOrderResultGUI extends JFrame {
    ...
    public SearchOrderResultGUI(order o) {    	
        ...
        JLabel phoneLabel = new JLabel("Order Date:");
        ...
        JTextField phoneField = new JTextField(o.transaction_date, 20);
        ...
        JLabel addressLabel = new JLabel("Order Total Amount:");
        ...
        String quantity=Double.toString(o.amount);
...
// Add anchor for the Address label to be on the left side
        ...
        JLabel emailLabel = new JLabel("Order Status:");
        ...
        JTextField dateField = new JTextField(o.status, 20);
