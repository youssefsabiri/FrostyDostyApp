...
import RemoteInterface.ModifyTransactionVerification2;

import javax.swing.*;
import java.awt.*;
import java.awt.event.*;

public class ModifyTransaction2GUI extends JFrame {
    /**
	 * 
	 */
    ...
    public ModifyTransaction2GUI(int code) {
        // Set up the frame
        ...
        // Add the title label
        JLabel titleLabel = new JLabel("Modify Amount");
        ...
        JLabel transactionCodeLabel = new JLabel("Transaction Amount:");
        ...
        enterButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                ModifyTransactionVerification2 dov = new ModifyTransactionVerification2();
                dov.verify(code, amount);
            }
        });
    ...
    public static void main(String[] args) {
    	int code = 0;
        ModifyTransaction2GUI form = new ModifyTransaction2GUI(code);
    }
}
