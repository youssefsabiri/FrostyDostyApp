...
public class AdminProductsGUI extends JFrame {
    ...
    public AdminProductsGUI() {
        // set up the JFrame
    	Database.productlist products = Main.products;
        ...
        String[] columns = {"Product Code", "Name", "Purchase Price", "Quantity On Hand", "Min Threshold" ,"location"};
        
        transactionsTableModel = new DefaultTableModel(columns, 0);
        transactionsTable = new JTable(transactionsTableModel);
        
        populateTableWithProductData(products);
    ...
    private void populateTableWithProductData(productlist list) {
