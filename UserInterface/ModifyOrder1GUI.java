...
import RemoteInterface.ModifyOrderVerification1;

import javax.swing.*;
import java.awt.*;
import java.awt.event.*;

public class ModifyOrder1GUI extends JFrame {
    /**
	 * 
	 */
    ...
    public ModifyOrder1GUI() {
        ...
        enterButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                ModifyOrderVerification1 dov = new ModifyOrderVerification1();
                dov.verify(code);
            }
        });
    ...
    public static void main(String[] args) {
        ModifyOrder1GUI form = new ModifyOrder1GUI();
    }
}