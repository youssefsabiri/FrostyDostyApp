...
import RemoteInterface.ModifyProductVerification1;

import javax.swing.*;
import java.awt.*;
import java.awt.event.*;

public class ModifyProduct1GUI extends JFrame {
    /**
	 * 
	 */
    ...
    public ModifyProduct1GUI() {
        ...
        JLabel transactionCodeLabel = new JLabel("Product Code:");
        ...
        enterButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                ModifyProductVerification1 dov = new ModifyProductVerification1();
                dov.verify(code);
            }
        });
    ...
    public static void main(String[] args) {
        ModifyProduct1GUI form = new ModifyProduct1GUI();
    }
}