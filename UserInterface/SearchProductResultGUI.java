...
public class SearchProductResultGUI extends JFrame {
    ...
    public SearchProductResultGUI(product p) {
        ...
        JLabel nameLabel = new JLabel("Inventory Number:");
        ...
        JTextField phoneField = new JTextField(p.Description, 20);
        ...
        String quantity=Integer.toString(p.quantity);
...
// Add anchor for the Address label to be on the left side
    ...
    public static void main(String[] args) {
    	product o = new product(0, "blank", 0, 0, "blank");
        new SearchProductResultGUI(o);
    }
}