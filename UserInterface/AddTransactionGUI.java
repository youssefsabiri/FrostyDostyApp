...
import Exceptions.AddTransactionVerification;
...
public class AddTransactionGUI extends JFrame {
    ...
    public AddTransactionGUI() {
        ...
        gbc.gridy++;
        JLabel transactionAmountLabel = new JLabel("Transaction Type ('E' for employee, 'S' for supplier):");
        transactionAmountLabel.setForeground(Color.WHITE);
        formPanel.add(transactionAmountLabel, gbc);

        gbc.gridy++;
        JLabel transactionDiscountLabel = new JLabel("Receiver ID:");
