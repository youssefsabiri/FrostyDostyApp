...
public class MenuIcedCoffeeGUI {
	...
	public static JPanel createHotDrinksPanel(Color backgroundColor, ActionListener backActionListener) {
	    ...
	    ImageIcon hotDrinksImageIcon = new ImageIcon(MenuHotDrinksGUI.class.getResource("iced.png"));
	    ...
	    JLabel titleLabel = new JLabel("Iced Coffee Menu");
