...
import RemoteInterface.ModifyTransactionVerification1;

import javax.swing.*;
import java.awt.*;
import java.awt.event.*;

public class ModifyTransaction1GUI extends JFrame {
    /**
	 * 
	 */
    ...
    public ModifyTransaction1GUI() {
        ...
        // Add the title label
        JLabel titleLabel = new JLabel("Modify Transaction");
        ...
        enterButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	String code = amountField.getText();
                ModifyTransactionVerification1 dov = new ModifyTransactionVerification1();
                dov.verify(code);
            }
        });
    ...
    public static void main(String[] args) {
        ModifyTransaction1GUI form = new ModifyTransaction1GUI();
    }
}
