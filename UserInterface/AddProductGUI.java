...
import Exceptions.AddProductVerification;
...
public class AddProductGUI extends JFrame {
    ...
    public AddProductGUI() {
        ...
        gbc.gridy++;
        JLabel transactionDateLabel = new JLabel("Product name:");
        ...
        enterButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                Main.products.add(101, description, price2, quantity2, 1,location);
