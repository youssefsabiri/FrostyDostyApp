...
public class AdminTransactionsGUI extends JPanel {
    ...
    public AdminTransactionsGUI() {
    	Database.transactionlist transactions = Main.transactions;
        ...
        String[] columns = {"Transaction Code", "Transaction Date", "Transaction Type", "Transaction Amount", "Receiver ID"};
        
        transactionsTableModel = new DefaultTableModel(columns, 0);
        transactionsTable = new JTable(transactionsTableModel);
        
        populateTableWithProductData(transactions);
        // style the table
    ...
    private void populateTableWithProductData(transactionlist list) {
