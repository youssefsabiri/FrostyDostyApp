...
import RemoteInterface.DeleteTransactionVerification;

import javax.swing.*;
import java.awt.*;
import java.awt.event.*;

public class DeleteTransactionGUI extends JFrame {
    /**
	 * 
	 */
    ...
    public DeleteTransactionGUI() {
        ...
        enterButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                DeleteTransactionVerification dtv = new DeleteTransactionVerification();
                dtv.verify(code);
            }
        });
    ...
    public static void main(String[] args) {
        DeleteTransactionGUI form = new DeleteTransactionGUI();
    }
}
