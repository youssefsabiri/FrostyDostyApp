...
public class MenuHotDrinksGUI {
	public static JPanel createHotDrinksPanel(Color backgroundColor, ActionListener backActionListener) {
	    ...
	    ImageIcon hotDrinksImageIcon = new ImageIcon(MenuHotDrinksGUI.class.getResource("hotdrinks.png"));
	    ...
	    JLabel titleLabel = new JLabel("Hot Drinks Menu");
